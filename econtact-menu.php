...
/*
EzPz CONTACT
by RADU VADUVA, http://raduvaduva.ro/

This file is part of EzPz CONTACT.
*/
...
?>
<div class="wrap">
	<h2><?php _e( 'EzPz Contact', 'easy_contact' ) ?></h2>
	<p><?php _e( 'Thank you for using this plugin. When deactivating this plugin, its settings will be permanently deleted from you database.', 'exop' ) ?></p>
	<form name="ec_options_update" method="post" action="<?php echo $_SERVER['REQUEST_URI'] ?>">
		...
		<table class="form-table" summary="<?php _e( 'Email Options', 'easy_contact' ) ?>">
			...
			<tr valign="top">
				<th scope="row"><?php _e( 'CC', 'easy_contact' ) ?></th>
				<td>
					<fieldset>
						<legend class="hidden"><?php _e( 'CC Option', 'easy_contact' ) ?></legend>
						<input id="option_cc" name="option_cc" type="checkbox" value="option_cc" <?php if ( get_option('ec_option_cc') == true ) echo 'checked="checked"'; ?> />
						<label for="option_cc"><?php _e( 'Allow users to CC emails to themselves', 'easy_contact' ) ?></label>
					</fieldset>
				</td>
			</tr>
		</table>
		...
		<table class="form-table" summary="<?php _e( 'Form Label text options', 'easy_contact' ) ?>">
			...
			<tr valign="top">
				<th scope="row"><label for="label_cc"><?php _e( 'CC Label', 'easy_contact' ) ?></label></th>
				<td>
					<fieldset>
						<legend class="hidden"><?php _e( 'CC Label Text', 'easy_contact' ) ?></legend>
